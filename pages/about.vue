...
<template>
  ...
  <section class="height-minus-nav my-bg bg-pink-darkest text-pink-100 md:px-8 md:flex items-end">

    <div class="p-5  mb-8 max-w-md bg-pink-800 md:bg-pink-darker md:rounded-lg">
